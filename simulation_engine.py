...
def run_SIA_380_1(gebaeudekategorie_sia, regelung, hohe_uber_meer, energiebezugsflache, anlagennutzungsgrad_wrg,
                  warmespeicherfahigkeit_pro_EBF, korrekturfaktor_luftungs_eff_f_v):
    ...
    theta_i_001 = standard_raumtemperaturen[gebaeudekategorie_sia] # Raumtemperatur in °C Gemäss SIA380-1 2016 Tab7 (grundsätzlich 20°C)
    delta_phi_i_002 = regelzuschlaege[regelung] # Regelungszuschlag für die Raumtemperatur [K] gemäss SIA380-1 2016 Tab8
    a_p_003 = personenflachen[gebaeudekategorie_sia]  # Personenfläche m2/P
    q_p_004 = warmeabgabe_p_p[gebaeudekategorie_sia] # Wärmeabgabe pro Person W/P
    t_p_005 = prasenzzeiten[gebaeudekategorie_sia]  # Präsenzzeit pro Tag h/d
    e_f_el_006 = elektrizitatsbedarf[gebaeudekategorie_sia]  # Elektrizitätsbedarf pro Jahr kWh/m2
    f_el_007 = reduktion_elektrizitat[gebaeudekategorie_sia]  # Reduktionsfaktor Elektrizität [-]
    q_th_008 = aussenluft_strome[gebaeudekategorie_sia]  # thermisch wirksamer Aussenluftvolumenstrom gem 3.5.5 m3/(hm2)

    h_010 = hohe_uber_meer  # Höhge über Meer [m]
    ...
    for month in range(12):  ## Zähler von 0-11
        ...
        a_e_017 = energiebezugsflache  # Energiebezugsfläche [m2]
        a_re_018 = np.array([506.])  # Dach gegen Aussenluft [m2]
        a_ru_019 = np.array([0])  # Decke gegen unbeheizte Räume [m2]
        a_we_020 = np.array([412.5, 412.5, 412.5, 412.5])  # Wand gegen Aussenluft [m2]
        ...
        cr_ae_078 = warmespeicherfahigkeit_pro_EBF  # Wärmespeicherfähigkeit pro EBF [kWh/(m2K)]
        ...
        eta_v_081 = anlagennutzungsgrad_wrg  # anlagennutzungsgrad der wärmerückgewinnung [-]
        f_v_082 = korrekturfaktor_luftungs_eff_f_v  # Korrekturfaktor für die Lüftungseffektivität [-]
        ...
        # print(q_sh_116, q_ss_117, q_se_118, q_sw_119, q_sn_120)
