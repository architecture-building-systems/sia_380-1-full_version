...
for index, config in configurations.iterrows():
    ...
    infiltration_volume_flow = config['infiltration volume flow']  # Gemäss SIA 380-1 2016 3.5.5 soll 0.15m3/(hm2) verwendet werden. Korrigenda anschauen
    ...
    print("Configuration %s prepared" %(index))


    print(type(config['roof area']))
    # quit()
